...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.LeaveRecordBase.renderItemOfList(item, targetComponents)

}



class LeaveRecordProfile extends Component {
...
}))(Form.create()(LeaveRecordProfile))
