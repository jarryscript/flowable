...
class LeaveRecordSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      leaveRecordList: 1,
      'leaveRecordList.searchField': fieldName,
      'leaveRecordList.searchVerb': 'startsWith',
      'leaveRecordList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        leaveRecordSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
               ...
               <SelectObject 
                 ...
                 targetType={"type"} 
                 requestFunction={LeaveRecordService.requestCandidateType} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"user"} 
                    requestFunction={LeaveRecordService.requestCandidateUser} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={LeaveRecordService.requestCandidatePlatform} useForSearch />
...
export default Form.create()(LeaveRecordSearchForm)
