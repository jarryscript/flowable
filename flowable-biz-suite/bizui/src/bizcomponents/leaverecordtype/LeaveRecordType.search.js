...
import styles from './LeaveRecordType.search.less'
...
class LeaveRecordTypeSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {LeaveRecordTypeTable} = GlobalComponents;
    const {LeaveRecordTypeSearchForm} = GlobalComponents;
    const {LeaveRecordTypeModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <LeaveRecordTypeSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,LeaveRecordTypeModalTable,"leaveRecordTypeIds")}
...
export default Form.create()(LeaveRecordTypeSearch)
