...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.LeaveRecordTypeBase.renderItemOfList(item, targetComponents)

}



class LeaveRecordTypeProfile extends Component {
  ...
  render() {
    ...
    const cardsData = {cardsName:"离开记录类型",cardsFor: "leaveRecordType",cardsSource: leaveRecordType,displayName,returnURL,
  		subItems: [
{name: 'holydaySettingList', displayName:'宗教节日的设置',type:'holydaySetting',count:holydaySettingCount,addFunction: true, role: 'holydaySetting',  renderItem: GlobalComponents.HolydaySettingBase.renderItemOfList},
...
}))(Form.create()(LeaveRecordTypeProfile))
