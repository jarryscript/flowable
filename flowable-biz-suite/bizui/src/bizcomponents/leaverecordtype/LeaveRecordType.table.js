...
class LeaveRecordTypeTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
    ...
    const operationColumn={
      ...
      render: (text, record) => (
        <span>
          ...
          { hasReadPermission(metaInfo)&&<Link to={`/leaveRecordType/${record.id}/dashboard`}>{appLocaleName(userContext,"View")}</Link>}
...
export default LeaveRecordTypeTable
