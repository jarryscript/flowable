...
class LeaveRecordTypeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      leaveRecordTypeList: 1,
      'leaveRecordTypeList.searchField': fieldName,
      'leaveRecordTypeList.searchVerb': 'startsWith',
      'leaveRecordTypeList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        leaveRecordTypeSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(LeaveRecordTypeSearchForm)
