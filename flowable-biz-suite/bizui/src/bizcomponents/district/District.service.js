...
const addUser = (targetObjectId, parameters) => {
  const url = `${PREFIX}districtManager/addUser/districtId/name/mobile/avatar/age/description/roleId/tokensExpr/`
...
const updateUser = (targetObjectId, parameters) => {
  const url = `${PREFIX}districtManager/updateUserProperties/districtId/id/name/mobile/avatar/age/description/tokensExpr/`
  const districtId = targetObjectId
  const requestParameters = { ...parameters, districtId, tokensExpr: 'none' }
  return postForm({ url,requestParameters})
}
...
const removeUserList = (targetObjectId, parameters) => {
  const url = `${PREFIX}districtManager/removeUserList/districtId/userIds/tokensExpr/`
