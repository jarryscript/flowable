...
constructor(props) {
  ...
  getUserSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('user','district.user_list',false),
      role: "user",
      data: state._district.userList,
      metaInfo: state._district.userListMetaInfo,
      count: state._district.userCount,
      returnURL: `/district/${state._district.id}/dashboard`,
      currentPage: state._district.userCurrentPageNumber,
      searchFormParameters: state._district.userSearchFormParameters,
      ...
      listName: 'userList', ref:state._district, 
  ...
  getUserCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._district.userSearchFormParameters,
      loading: state._district.loading,
      owner: { type: '_district', id: state._district.id, referenceName: 'district', listName: 'userList', ref:state._district, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
    }))(UserCreateForm)
  }
  ...
  getUserUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_district', id: state._district.id, listName: 'userList', ref:state._district, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
    }))(UserUpdateForm)
  }
  ...
  buildRouters = () =>{
  	...
  	{path:"/district/:id/list/userList", component: this.getUserSearch()},
  	{path:"/district/:id/list/userCreateForm", component: this.getUserCreateForm()},
  	{path:"/district/:id/list/userUpdateForm", component: this.getUserUpdateForm()},
