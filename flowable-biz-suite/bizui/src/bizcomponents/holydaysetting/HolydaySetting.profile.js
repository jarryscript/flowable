...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.HolydaySettingBase.renderItemOfList(item, targetComponents)

}



class HolydaySettingProfile extends Component {
...
}))(Form.create()(HolydaySettingProfile))
