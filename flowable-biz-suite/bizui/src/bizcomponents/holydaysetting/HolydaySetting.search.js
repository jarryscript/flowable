...
import styles from './HolydaySetting.search.less'
...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
    ...
    <LeaveRecordTypeAssociateForm 
	visible={currentAssociateModal==='type'} 
	data={{holydaySettingList:selectedRows}} owner={owner}  
...
class HolydaySettingSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {HolydaySettingTable} = GlobalComponents;
    const {HolydaySettingSearchForm} = GlobalComponents;
    const {HolydaySettingModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <HolydaySettingSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,HolydaySettingModalTable,"holydaySettingIds")}
...
export default Form.create()(HolydaySettingSearch)
