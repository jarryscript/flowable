...
class HolydaySettingSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      holydaySettingList: 1,
      'holydaySettingList.searchField': fieldName,
      'holydaySettingList.searchVerb': 'startsWith',
      'holydaySettingList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        holydaySettingSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
               ...
               <SelectObject 
                 ...
                 targetType={"type"} 
                 requestFunction={HolydaySettingService.requestCandidateType} useForSearch />
...
export default Form.create()(HolydaySettingSearchForm)
