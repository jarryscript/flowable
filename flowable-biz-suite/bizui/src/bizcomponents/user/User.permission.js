...
<Description term="手机号码">{user.mobile}</Description> 
<Description term="头像">{user.avatar}</Description> 
<Description term="年龄">{user.age}</Description> 
...
class UserPermission extends Component {
  ...
  render() {
    ...
    const { id,displayName, leaveRecordCount } = user
