...
import styles from './User.createform.less'
...
class UserAssociateForm extends Component {
  state = {
 ...
 <Modal
            ...
            <Row gutter={16}>
              ...
              <Col lg={12} md={12} sm={24}>
                ...
                <SelectObject 
                    ...
                    targetType={"district"} 
                    requestFunction={UserService.requestCandidateDistrict}/>
              ...
              <Col lg={12} md={12} sm={24}>
                ...
                <SelectObject 
                    ...
                    targetType={"role"} 
                    requestFunction={UserService.requestCandidateRole}/>
	...
	<LeaveRecordModalTable data={data.leaveRecordList} owner={owner} />
