...
class RoleSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      roleList: 1,
      'roleList.searchField': fieldName,
      'roleList.searchVerb': 'startsWith',
      'roleList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        roleSearchFormParameters: filterObjectKeys(fieldsValue),
