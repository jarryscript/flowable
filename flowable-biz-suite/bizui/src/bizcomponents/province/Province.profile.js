...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.ProvinceBase.renderItemOfList(item, targetComponents)

}



class ProvinceProfile extends Component {
  ...
  render() {
    ...
    const { id,displayName, cityCount } = province
