...
public class FlowableNamingServiceDAO extends CommonJDBCTemplateDAO {
	...
	static {
		...
		namingTableMap.put("Role", new String[]{"role_data","name"});
		namingTableMap.put("LeaveRecord", new String[]{"leave_record_data","id"});
		namingTableMap.put("LeaveRecordType", new String[]{"leave_record_type_data","name"});
		namingTableMap.put("HolydaySetting", new String[]{"holyday_setting_data","id"});
		namingTableMap.put("Province", new String[]{"province_data","name"});
		namingTableMap.put("City", new String[]{"city_data","name"});
		namingTableMap.put("District", new String[]{"district_data","name"});
