...
@JsonSerialize(using = FlowableExceptionJsonSerializer.class)
public class FlowableException extends Exception implements MessageContainer {
    ...
    public FlowableException(Message message) {
    	super();
        this.addErrorMessage(message);
    }
	public FlowableException(List<Message> messageList) {
        super();
