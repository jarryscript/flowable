package com.doublechain.flowable.utils;
...
public class BaseBizHelper {
	protected CustomFlowableUserContextImpl userContext;
	protected static final Map<String, Object> EO = new HashMap<>();
	protected Map<String, Object> cache;
	
	public CustomFlowableUserContextImpl getUserContext() {
		return userContext;
	}
	public void setUserContext(CustomFlowableUserContextImpl userContext) {
		this.userContext = userContext;
	}

	protected static <T extends BaseBizHelper> T _OF(CustomFlowableUserContextImpl ctx, Class<T> clazz) {
		return _OF(ctx, clazz, false);
	}
			
	protected static <T extends BaseBizHelper> T _OF(CustomFlowableUserContextImpl ctx,
