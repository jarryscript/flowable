...
public class GenericFormManagerImpl extends CustomFlowableCheckerManager implements GenericFormManager, BusinessHandler{
	...
	@Override
	public GenericFormDAO daoOf(FlowableUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws GenericFormManagerException{
 	...
 	protected GenericForm saveGenericForm(FlowableUserContext userContext, GenericForm genericForm, String [] tokensExpr) throws Exception{	
 	...
 	protected GenericForm saveGenericFormDetail(FlowableUserContext userContext, GenericForm genericForm) throws Exception{	
 	...
 	public GenericForm loadGenericForm(FlowableUserContext userContext, String genericFormId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public GenericForm searchGenericForm(FlowableUserContext userContext, String genericFormId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected GenericForm present(FlowableUserContext userContext, GenericForm genericForm, Map<String, Object> tokens) throws Exception {
 	...
 	public GenericForm loadGenericFormDetail(FlowableUserContext userContext, String genericFormId) throws Exception{	
 	...
 	public Object view(FlowableUserContext userContext, String genericFormId) throws Exception{	
 		GenericForm genericForm = loadGenericForm( userContext, genericFormId, viewTokens());
 		return present(userContext,genericForm, allTokens());
		
 	}
 	protected GenericForm saveGenericForm(FlowableUserContext userContext, GenericForm genericForm, Map<String,Object>tokens) throws Exception{	
 		return genericFormDaoOf(userContext).save(genericForm, tokens);
 	}
 	protected GenericForm loadGenericForm(FlowableUserContext userContext, String genericFormId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfGenericForm(genericFormId);
		checkerOf(userContext).throwExceptionIfHasErrors( GenericFormManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(FlowableUserContext userContext, GenericForm genericForm, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(FlowableUserContext userContext, GenericForm genericForm, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingGenericForm(FlowableUserContext userContext,String genericFormId, int genericFormVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public GenericForm clone(FlowableUserContext userContext, String fromGenericFormId) throws Exception{
	...
	public GenericForm internalSaveGenericForm(FlowableUserContext userContext, GenericForm genericForm, Map<String,Object> options) throws Exception
	{
	...
	public GenericForm updateGenericFormProperty(FlowableUserContext userContext,String genericFormId, int genericFormVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingGenericForm(userContext, genericFormId, genericFormVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(FlowableUserContext userContext, String genericFormId, int genericFormVersion) throws Exception {
	...
	public GenericForm forgetByAll(FlowableUserContext userContext, String genericFormId, int genericFormVersion) throws Exception {
		return forgetByAllInternal(userContext, genericFormId, genericFormVersion);
	}
	protected GenericForm forgetByAllInternal(FlowableUserContext userContext,
			String genericFormId, int genericFormVersion) throws Exception{
	...
	protected void checkParamsForAddingFormMessage(FlowableUserContext userContext, String genericFormId, String title, String level,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormMessageProperties(FlowableUserContext userContext, String genericFormId,String id,String title,String level,String [] tokensExpr) throws Exception {
	...
	public  GenericForm updateFormMessageProperties(FlowableUserContext userContext, String genericFormId, String id,String title,String level, String [] tokensExpr) throws Exception
	{
	...
	protected FormMessage createFormMessage(FlowableUserContext userContext, String title, String level) throws Exception{
	...
	protected void checkParamsForRemovingFormMessageList(FlowableUserContext userContext, String genericFormId,
	...
	public  GenericForm removeFormMessageList(FlowableUserContext userContext, String genericFormId,
			String formMessageIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormMessage(FlowableUserContext userContext, String genericFormId,
	...
	public  GenericForm removeFormMessage(FlowableUserContext userContext, String genericFormId,
		String formMessageId, int formMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormMessage(FlowableUserContext userContext, String genericFormId,
		String formMessageId, int formMessageVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormMessageFrom(FlowableUserContext userContext, String genericFormId,
		String formMessageId, int formMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormMessage(FlowableUserContext userContext, String genericFormId, String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormMessage(FlowableUserContext userContext, String genericFormId, String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingFormFieldMessage(FlowableUserContext userContext, String genericFormId, String title, String parameterName, String level,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormFieldMessageProperties(FlowableUserContext userContext, String genericFormId,String id,String title,String parameterName,String level,String [] tokensExpr) throws Exception {
	...
	public  GenericForm updateFormFieldMessageProperties(FlowableUserContext userContext, String genericFormId, String id,String title,String parameterName,String level, String [] tokensExpr) throws Exception
	{
	...
	protected FormFieldMessage createFormFieldMessage(FlowableUserContext userContext, String title, String parameterName, String level) throws Exception{
	...
	protected void checkParamsForRemovingFormFieldMessageList(FlowableUserContext userContext, String genericFormId,
	...
	public  GenericForm removeFormFieldMessageList(FlowableUserContext userContext, String genericFormId,
			String formFieldMessageIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormFieldMessage(FlowableUserContext userContext, String genericFormId,
	...
	public  GenericForm removeFormFieldMessage(FlowableUserContext userContext, String genericFormId,
		String formFieldMessageId, int formFieldMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormFieldMessage(FlowableUserContext userContext, String genericFormId,
		String formFieldMessageId, int formFieldMessageVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormFieldMessageFrom(FlowableUserContext userContext, String genericFormId,
		String formFieldMessageId, int formFieldMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormFieldMessage(FlowableUserContext userContext, String genericFormId, String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormFieldMessage(FlowableUserContext userContext, String genericFormId, String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	public  GenericForm updateFormFieldProperties(FlowableUserContext userContext, String genericFormId, String id,String label,String localeKey,String parameterName,String type,String placeholder,String defaultValue,String description,String fieldGroup,String minimumValue,String maximumValue,boolean required,boolean disabled,boolean customRendering,String candidateValues,String suggestValues, String [] tokensExpr) throws Exception
	{
	...
	protected FormField createFormField(FlowableUserContext userContext, String label, String localeKey, String parameterName, String type, String placeholder, String defaultValue, String description, String fieldGroup, String minimumValue, String maximumValue, boolean required, boolean disabled, boolean customRendering, String candidateValues, String suggestValues) throws Exception{
	...
	protected void checkParamsForRemovingFormFieldList(FlowableUserContext userContext, String genericFormId,
	...
	public  GenericForm removeFormFieldList(FlowableUserContext userContext, String genericFormId,
			String formFieldIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormField(FlowableUserContext userContext, String genericFormId,
	...
	public  GenericForm removeFormField(FlowableUserContext userContext, String genericFormId,
		String formFieldId, int formFieldVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormField(FlowableUserContext userContext, String genericFormId,
		String formFieldId, int formFieldVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormFieldFrom(FlowableUserContext userContext, String genericFormId,
		String formFieldId, int formFieldVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormField(FlowableUserContext userContext, String genericFormId, String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormField(FlowableUserContext userContext, String genericFormId, String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingFormAction(FlowableUserContext userContext, String genericFormId, String label, String localeKey, String actionKey, String level, String url,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormActionProperties(FlowableUserContext userContext, String genericFormId,String id,String label,String localeKey,String actionKey,String level,String url,String [] tokensExpr) throws Exception {
	...
	public  GenericForm updateFormActionProperties(FlowableUserContext userContext, String genericFormId, String id,String label,String localeKey,String actionKey,String level,String url, String [] tokensExpr) throws Exception
	{
	...
	protected FormAction createFormAction(FlowableUserContext userContext, String label, String localeKey, String actionKey, String level, String url) throws Exception{
	...
	protected void checkParamsForRemovingFormActionList(FlowableUserContext userContext, String genericFormId,
	...
	public  GenericForm removeFormActionList(FlowableUserContext userContext, String genericFormId,
			String formActionIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormAction(FlowableUserContext userContext, String genericFormId,
	...
	public  GenericForm removeFormAction(FlowableUserContext userContext, String genericFormId,
		String formActionId, int formActionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormAction(FlowableUserContext userContext, String genericFormId,
		String formActionId, int formActionVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormActionFrom(FlowableUserContext userContext, String genericFormId,
		String formActionId, int formActionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormAction(FlowableUserContext userContext, String genericFormId, String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormAction(FlowableUserContext userContext, String genericFormId, String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
