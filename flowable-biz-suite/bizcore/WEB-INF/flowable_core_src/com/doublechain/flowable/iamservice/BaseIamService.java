...
// import com.doublechain.flowable.FlowableBizUserContextImpl;
import com.doublechain.flowable.FlowableUserContextImpl;
import com.doublechain.flowable.UserContext;
...
public abstract class BaseIamService {
	...
	public LoginResult doLogin(FlowableUserContextImpl userContext, LoginContext loginContext, BusinessHandler bizHandler) throws Exception {
	 ...
	 * @throws Exception 
	 */
	protected void onAuthenticateNewUserLogged(FlowableUserContextImpl userContext, LoginContext loginContext,
	 ...
	 * 
	 */
	protected void onAuthenticateUserLogged(FlowableUserContextImpl userContext, LoginContext loginContext,
			LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler) throws Exception {
		// 回调业务
	...
	// 为兼容旧版本secUser登录接口
	public void onLoginSecUserInternalSuccess(FlowableUserContextImpl userContext, SecUser user) {
		String tokenKey = userContext.tokenId();
		// 生成 jwtToken
	 ...
	 */
	protected boolean isLoginClientSupportSession(FlowableUserContextImpl userContext, LoginContext loginContext,
	 ...
	 */
	protected void onAuthenticationFailed(FlowableUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
	 ...
	 * @return
	 */
	protected IdentificationHandler selectIdentificationHandler(FlowableUserContextImpl userContext, LoginContext loginContext) {
		if (idHandlers == null) {
	...
	protected String getLoginInfoCacheKey(FlowableUserContextImpl userContext) {
		return this.getCacheKey(userContext, "loginInfo");
	}
	protected String getJwtTokenCacheKey(FlowableUserContextImpl userContext) {
		return this.getCacheKey(userContext, "jwtToken");
	}
	
	// 获取token key的优先级为: jwtToken->cookie->session id
	public String getTokenKey(FlowableUserContextImpl userContext) {
	...
	protected void cacheJwtToken(FlowableUserContextImpl userContext, DecodedJWT jwtToken) {
		userContext.putIntoContextLocalStorage(getJwtTokenCacheKey(userContext), jwtToken);
	}
	protected DecodedJWT getCachedJwtToken(FlowableUserContextImpl userContext) {
		return (DecodedJWT) userContext.getFromContextLocalStorage(getJwtTokenCacheKey(userContext));
	}
	
	protected DecodedJWT getJwtTokenFromCookie(FlowableUserContextImpl userContext) {
	...
	protected DecodedJWT getJwtTokenFromHeader(FlowableUserContextImpl userContext) {
	...
	public Map<String, Object> getCachedLoginInfo(FlowableUserContextImpl userContext) {
	...
	protected String getCacheKey(UserContext userContext, String prefix){
		return "flowable:"+prefix+":"+userContext.tokenId();
	}
	protected String getUserKey(UserContext userContext){
		return "flowable:user:"+userContext.tokenId();
	}
	protected String getCurrentAppKey(UserContext userContext){
		return getUserKey(userContext)+":currentApp";
	}
	protected void fixUserContextTokenId(FlowableUserContextImpl userContext, String tokenKey) {
		if (!userContext.tokenId().equals(tokenKey)) {
			userContext.setTokenId(tokenKey);
		}
	}
	public SecUser tryToLoadSecUser(FlowableUserContextImpl userContext, Map<String, Object> loginInfo){
		if(loginInfo == null) {
			return null;
		}
	...
	public UserApp tryToLoadUserApp(FlowableUserContextImpl userContext, Map<String, Object> loginInfo){
		if(loginInfo == null) {
			return null;
		}
...
//	
//	
//	protected boolean onSecUserNotFoundWhenCheckAccess(FlowableUserContextImpl userContext, Map<String, Object> loginInfo,
//			SecUser secUser, UserApp userApp) {
//		return false;
//	}
//	protected boolean onSecUserFoundWhenCheckAccess(FlowableUserContextImpl userContext, Map<String, Object> loginInfo,
//			SecUser secUser, UserApp userApp) {
//		return true;
//	}
//	protected boolean onSecUserAppFoundWhenCheckAccess(FlowableUserContextImpl userContext, Map<String, Object> loginInfo,
//			SecUser secUser, UserApp userApp) {
//		return true;
//	}
//	protected SecUser tryToLoadSecUser(FlowableUserContextImpl userContext, Map<String, Object> loginInfo){
//		if(loginInfo == null) {
//			return null;
//		}
//		String secUserId = (String) loginInfo.get("secUser");
...
//		}
//	}
//	protected UserApp tryToLoadUserApp(FlowableUserContextImpl userContext, Map<String, Object> loginInfo){
//		if(loginInfo == null) {
//			return null;
//		}
//		
...
//	
//	
//	public Object exampleLoginByAccountPassword(FlowableUserContextImpl userContext, String acct, String password) throws Exception {
//		
//		BusinessHandler bizHandler = new BusinessHandler() {
//			public void onAuthenticationFailed(FlowableUserContextImpl userContext, LoginContext loginContext,
//					LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler)
//					throws Exception {
//				onFailExample(userContext, loginContext, loginResult, idHandler, bizHandler);
//			}
//			public void onAuthenticateNewUserLogged(FlowableUserContextImpl userContext, LoginContext loginContext,
//					LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler)
//					throws Exception {
//				onNewExample(userContext, loginContext, loginResult, idHandler, bizHandler);
//			}
//			public void onAuthenticateUserLogged(FlowableUserContextImpl userContext, LoginContext loginContext,
//					LoginResult loginResult, IdentificationHandler idHandler, BusinessHandler bizHandler)
//					throws Exception {
...
//	}
//	
//	protected Object onFailExample(FlowableUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
//			IdentificationHandler idHandler, BusinessHandler bizHandler) {
//		// TODO Auto-generated method stub
//		return null;
//	}
//	protected Object onNewExample(FlowableUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
//			IdentificationHandler idHandler, BusinessHandler bizHandler) {
//		// 新用户来了,我也不知道该干嘛,所以报错
...
//		return null;
//	}
//	protected Object onSuccessExample(FlowableUserContextImpl userContext, LoginContext loginContext, LoginResult loginResult,
//			IdentificationHandler idHandler, BusinessHandler bizHandler) {
//		// 成功了就直接记载第一个userApp
//		SecUser secUser = loginResult.getLoginContext().getLoginTarget().getSecUser();
