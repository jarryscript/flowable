...
public class WechatMiniprogramHandler extends BaseIdentificationHandler {
	...
	@Override
	public LoginResult authenticate(FlowableUserContext userContext, LoginContext loginContext) {
	...
	protected boolean authenticateWithCode(FlowableUserContext userContext, String code, LoginResult result) throws Exception{
	...
	@Override
	public void bindWithSecUser(FlowableUserContext userContext, LoginContext loginContext) throws Exception {
	...
	protected SmartList<WechatMiniappIdentify> getIdentifyRecords(FlowableUserContext userContext,
