...
public class FlowableExceptionJsonSerializer extends  JsonSerializer<FlowableException> {
	...
	@Override
	public void serialize(FlowableException exception, JsonGenerator jgen,
	...
	protected void writeExceptionMessage(String message, FlowableException exception,
	...
	protected void writeStartObject(FlowableException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		jgen.writeStartObject();
		writeClassField(CLASS,exception,jgen,provider);
	}
	
	private static final String MESSAGE_LIST = "messageList";
	protected void writeEndObject(FlowableException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		
		writeMessageList(MESSAGE_LIST,exception,jgen,provider);
		jgen.writeEndObject();
	}
	protected void writeClassField(String fieldName,FlowableException exception,
	...
	protected void writeMessageList(String fieldName,FlowableException exception,
			JsonGenerator jgen, SerializerProvider provider)
			throws IOException, JsonProcessingException {
		if(exception == null){
			return; //do nothing when base entity is null
