...
import com.doublechain.flowable.secuser.SecUserCustomManagerImpl;
...
public class FlowableUserContextImpl extends UserContextImpl implements FlowableUserContext{
	...
	static final String RESOURCE_PATH="com.doublechain.flowable.FlowableResources";
	static final String CUSTOM_RESOURCE_PATH="com.doublechain.flowable.FlowableCustomResources";
    ...
    /*
    public static SecUser getSecUser(FlowableUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(FlowableUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(FlowableUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(FlowableUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
	...
	private FlowableObjectChecker checker;
