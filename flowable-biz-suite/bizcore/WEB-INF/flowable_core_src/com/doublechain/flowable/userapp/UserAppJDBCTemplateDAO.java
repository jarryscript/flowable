...
public class UserAppJDBCTemplateDAO extends FlowableBaseDAOImpl implements UserAppDAO{
	...
	*/
    ...
    public SmartList<UserApp> requestCandidateUserAppForQuickLink(FlowableUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<UserApp> requestCandidateUserAppForListAccess(FlowableUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(UserAppTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getUserAppMapper());
    }
		
    public SmartList<UserApp> requestCandidateUserAppForObjectAccess(FlowableUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(UserAppTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getUserAppMapper());
    }
	...
	public SmartList<QuickLink> loadOurQuickLinkList(FlowableUserContext userContext, List<UserApp> us, Map<String,Object> options) throws Exception{
	...
	public SmartList<ListAccess> loadOurListAccessList(FlowableUserContext userContext, List<UserApp> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return new SmartList<>();
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
	...
	public SmartList<ObjectAccess> loadOurObjectAccessList(FlowableUserContext userContext, List<UserApp> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return new SmartList<>();
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
