...
import com.doublechain.flowable.candidatecontainer.CandidateCandidateContainer;
...
public class CandidateElementManagerImpl extends CustomFlowableCheckerManager implements CandidateElementManager, BusinessHandler{
	...
	@Override
	public CandidateElementDAO daoOf(FlowableUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws CandidateElementManagerException{
 	...
 	protected CandidateElement saveCandidateElement(FlowableUserContext userContext, CandidateElement candidateElement, String [] tokensExpr) throws Exception{	
 	...
 	protected CandidateElement saveCandidateElementDetail(FlowableUserContext userContext, CandidateElement candidateElement) throws Exception{	
 	...
 	public CandidateElement loadCandidateElement(FlowableUserContext userContext, String candidateElementId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public CandidateElement searchCandidateElement(FlowableUserContext userContext, String candidateElementId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected CandidateElement present(FlowableUserContext userContext, CandidateElement candidateElement, Map<String, Object> tokens) throws Exception {
 	...
 	public CandidateElement loadCandidateElementDetail(FlowableUserContext userContext, String candidateElementId) throws Exception{	
 	...
 	public Object view(FlowableUserContext userContext, String candidateElementId) throws Exception{	
 		CandidateElement candidateElement = loadCandidateElement( userContext, candidateElementId, viewTokens());
 		return present(userContext,candidateElement, allTokens());
		
 	}
 	protected CandidateElement saveCandidateElement(FlowableUserContext userContext, CandidateElement candidateElement, Map<String,Object>tokens) throws Exception{	
 		return candidateElementDaoOf(userContext).save(candidateElement, tokens);
 	}
 	protected CandidateElement loadCandidateElement(FlowableUserContext userContext, String candidateElementId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfCandidateElement(candidateElementId);
		checkerOf(userContext).throwExceptionIfHasErrors( CandidateElementManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(FlowableUserContext userContext, CandidateElement candidateElement, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(FlowableUserContext userContext, CandidateElement candidateElement, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingCandidateElement(FlowableUserContext userContext,String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public CandidateElement clone(FlowableUserContext userContext, String fromCandidateElementId) throws Exception{
	...
	public CandidateElement internalSaveCandidateElement(FlowableUserContext userContext, CandidateElement candidateElement, Map<String,Object> options) throws Exception
	{
	...
	public CandidateElement updateCandidateElementProperty(FlowableUserContext userContext,String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingCandidateElement(userContext, candidateElementId, candidateElementVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherContainer(FlowableUserContext userContext, String candidateElementId, String anotherContainerId) throws Exception
 	{
	...
	public CandidateCandidateContainer requestCandidateContainer(FlowableUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected CandidateContainer loadCandidateContainer(FlowableUserContext userContext, String newContainerId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(FlowableUserContext userContext, String candidateElementId, int candidateElementVersion) throws Exception {
	...
	public CandidateElement forgetByAll(FlowableUserContext userContext, String candidateElementId, int candidateElementVersion) throws Exception {
		return forgetByAllInternal(userContext, candidateElementId, candidateElementVersion);
	}
	protected CandidateElement forgetByAllInternal(FlowableUserContext userContext,
			String candidateElementId, int candidateElementVersion) throws Exception{
