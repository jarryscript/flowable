...
public class FormMessageManagerImpl extends CustomFlowableCheckerManager implements FormMessageManager, BusinessHandler{
	...
	@Override
	public FormMessageDAO daoOf(FlowableUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws FormMessageManagerException{
 	...
 	protected FormMessage saveFormMessage(FlowableUserContext userContext, FormMessage formMessage, String [] tokensExpr) throws Exception{	
 	...
 	protected FormMessage saveFormMessageDetail(FlowableUserContext userContext, FormMessage formMessage) throws Exception{	
 	...
 	public FormMessage loadFormMessage(FlowableUserContext userContext, String formMessageId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormMessage searchFormMessage(FlowableUserContext userContext, String formMessageId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormMessage present(FlowableUserContext userContext, FormMessage formMessage, Map<String, Object> tokens) throws Exception {
 	...
 	public FormMessage loadFormMessageDetail(FlowableUserContext userContext, String formMessageId) throws Exception{	
 	...
 	public Object view(FlowableUserContext userContext, String formMessageId) throws Exception{	
 		FormMessage formMessage = loadFormMessage( userContext, formMessageId, viewTokens());
 		return present(userContext,formMessage, allTokens());
		
 	}
 	protected FormMessage saveFormMessage(FlowableUserContext userContext, FormMessage formMessage, Map<String,Object>tokens) throws Exception{	
 		return formMessageDaoOf(userContext).save(formMessage, tokens);
 	}
 	protected FormMessage loadFormMessage(FlowableUserContext userContext, String formMessageId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfFormMessage(formMessageId);
		checkerOf(userContext).throwExceptionIfHasErrors( FormMessageManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(FlowableUserContext userContext, FormMessage formMessage, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(FlowableUserContext userContext, FormMessage formMessage, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormMessage(FlowableUserContext userContext,String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormMessage clone(FlowableUserContext userContext, String fromFormMessageId) throws Exception{
	...
	public FormMessage internalSaveFormMessage(FlowableUserContext userContext, FormMessage formMessage, Map<String,Object> options) throws Exception
	{
	...
	public FormMessage updateFormMessageProperty(FlowableUserContext userContext,String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingFormMessage(userContext, formMessageId, formMessageVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(FlowableUserContext userContext, String formMessageId, String anotherFormId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(FlowableUserContext userContext, String formMessageId, int formMessageVersion) throws Exception {
	...
	public FormMessage forgetByAll(FlowableUserContext userContext, String formMessageId, int formMessageVersion) throws Exception {
		return forgetByAllInternal(userContext, formMessageId, formMessageVersion);
	}
	protected FormMessage forgetByAllInternal(FlowableUserContext userContext,
			String formMessageId, int formMessageVersion) throws Exception{
