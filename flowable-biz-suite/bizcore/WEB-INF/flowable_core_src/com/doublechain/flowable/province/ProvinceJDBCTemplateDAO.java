...
public class ProvinceJDBCTemplateDAO extends FlowableBaseDAOImpl implements ProvinceDAO{
	...
	*/
	...
	protected boolean isUpdateRequest(Province province){
 	...
 	protected Object[] prepareProvinceUpdateParameters(Province province){
 		...
 		parameters[2] = province.nextVersion();
 		parameters[3] = province.getId();
 		parameters[4] = province.getVersion();
