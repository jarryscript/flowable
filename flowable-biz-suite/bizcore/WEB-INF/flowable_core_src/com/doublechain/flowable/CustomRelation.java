...
public class CustomRelation extends BaseRelation{
	...
	protected void prepareRelation()
	{
		...
		//replaceGenericRelation("User"                                  , BaseRelation.TRUST_CHAIN_ALL, "district");
		//replaceGenericRelation("LeaveRecord"                           , BaseRelation.TRUST_CHAIN_ALL, "user");
		//replaceGenericRelation("LeaveRecord"                           , BaseRelation.TRUST_CHAIN_ALL, "type");
		//replaceGenericRelation("LeaveRecord"                           , BaseRelation.TRUST_CHAIN_ALL, "platform");
		//replaceGenericRelation("HolydaySetting"                        , BaseRelation.TRUST_CHAIN_ALL, "type");
	...
	protected void prepareRelationIndex()
	{
		...
		*/
		//String [] userRelatedObjectNames = {"district:District"};
		//replaceRelationIndex("User",userRelatedObjectNames);

		//String [] leaveRecordRelatedObjectNames = {"user:User","type:LeaveRecordType","platform:Platform"};
		//replaceRelationIndex("LeaveRecord",leaveRecordRelatedObjectNames);

		//String [] holydaySettingRelatedObjectNames = {"type:LeaveRecordType"};
		//replaceRelationIndex("HolydaySetting",holydaySettingRelatedObjectNames);
