...
public class CandidateContainerManagerImpl extends CustomFlowableCheckerManager implements CandidateContainerManager, BusinessHandler{
	...
	@Override
	public CandidateContainerDAO daoOf(FlowableUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws CandidateContainerManagerException{
 	...
 	protected CandidateContainer saveCandidateContainer(FlowableUserContext userContext, CandidateContainer candidateContainer, String [] tokensExpr) throws Exception{	
 	...
 	protected CandidateContainer saveCandidateContainerDetail(FlowableUserContext userContext, CandidateContainer candidateContainer) throws Exception{	
 	...
 	public CandidateContainer loadCandidateContainer(FlowableUserContext userContext, String candidateContainerId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public CandidateContainer searchCandidateContainer(FlowableUserContext userContext, String candidateContainerId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected CandidateContainer present(FlowableUserContext userContext, CandidateContainer candidateContainer, Map<String, Object> tokens) throws Exception {
 	...
 	public CandidateContainer loadCandidateContainerDetail(FlowableUserContext userContext, String candidateContainerId) throws Exception{	
 	...
 	public Object view(FlowableUserContext userContext, String candidateContainerId) throws Exception{	
 		CandidateContainer candidateContainer = loadCandidateContainer( userContext, candidateContainerId, viewTokens());
 		return present(userContext,candidateContainer, allTokens());
		
 	}
 	protected CandidateContainer saveCandidateContainer(FlowableUserContext userContext, CandidateContainer candidateContainer, Map<String,Object>tokens) throws Exception{	
 		return candidateContainerDaoOf(userContext).save(candidateContainer, tokens);
 	}
 	protected CandidateContainer loadCandidateContainer(FlowableUserContext userContext, String candidateContainerId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfCandidateContainer(candidateContainerId);
		checkerOf(userContext).throwExceptionIfHasErrors( CandidateContainerManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(FlowableUserContext userContext, CandidateContainer candidateContainer, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(FlowableUserContext userContext, CandidateContainer candidateContainer, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingCandidateContainer(FlowableUserContext userContext,String candidateContainerId, int candidateContainerVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public CandidateContainer clone(FlowableUserContext userContext, String fromCandidateContainerId) throws Exception{
	...
	public CandidateContainer internalSaveCandidateContainer(FlowableUserContext userContext, CandidateContainer candidateContainer, Map<String,Object> options) throws Exception
	{
	...
	public CandidateContainer updateCandidateContainerProperty(FlowableUserContext userContext,String candidateContainerId, int candidateContainerVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingCandidateContainer(userContext, candidateContainerId, candidateContainerVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(FlowableUserContext userContext, String candidateContainerId, int candidateContainerVersion) throws Exception {
	...
	public CandidateContainer forgetByAll(FlowableUserContext userContext, String candidateContainerId, int candidateContainerVersion) throws Exception {
		return forgetByAllInternal(userContext, candidateContainerId, candidateContainerVersion);
	}
	protected CandidateContainer forgetByAllInternal(FlowableUserContext userContext,
			String candidateContainerId, int candidateContainerVersion) throws Exception{
	...
	protected void checkParamsForAddingCandidateElement(FlowableUserContext userContext, String candidateContainerId, String name, String type, String image,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCandidateElementProperties(FlowableUserContext userContext, String candidateContainerId,String id,String name,String type,String image,String [] tokensExpr) throws Exception {
	...
	public  CandidateContainer updateCandidateElementProperties(FlowableUserContext userContext, String candidateContainerId, String id,String name,String type,String image, String [] tokensExpr) throws Exception
	{
	...
	protected CandidateElement createCandidateElement(FlowableUserContext userContext, String name, String type, String image) throws Exception{
	...
	protected void checkParamsForRemovingCandidateElementList(FlowableUserContext userContext, String candidateContainerId,
	...
	public  CandidateContainer removeCandidateElementList(FlowableUserContext userContext, String candidateContainerId,
			String candidateElementIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingCandidateElement(FlowableUserContext userContext, String candidateContainerId,
	...
	public  CandidateContainer removeCandidateElement(FlowableUserContext userContext, String candidateContainerId,
		String candidateElementId, int candidateElementVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingCandidateElement(FlowableUserContext userContext, String candidateContainerId,
		String candidateElementId, int candidateElementVersion,String [] tokensExpr) throws Exception{
	...
	public  CandidateContainer copyCandidateElementFrom(FlowableUserContext userContext, String candidateContainerId,
		String candidateElementId, int candidateElementVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCandidateElement(FlowableUserContext userContext, String candidateContainerId, String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  CandidateContainer updateCandidateElement(FlowableUserContext userContext, String candidateContainerId, String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
