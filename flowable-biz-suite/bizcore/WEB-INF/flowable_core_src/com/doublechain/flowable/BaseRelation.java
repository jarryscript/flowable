...
public class BaseRelation{
	...
	protected void prepareRelationIndex()
	{
		...
		String [] userRelatedObjectNames = {"district:District","role:Role"};
		...
		addRelationIndex("LeaveRecord",leaveRecordRelatedObjectNames);

		String [] holydaySettingRelatedObjectNames = {"type:LeaveRecordType"};
		addRelationIndex("HolydaySetting",holydaySettingRelatedObjectNames);
	...
	{
		addGenericRelation("User"                                  ,TRUST_CHAIN_READ,"district");
		addGenericRelation("User"                                  ,TRUST_CHAIN_READ,"role");
		addGenericRelation("LeaveRecord"                           ,TRUST_CHAIN_READ,"user");
		addGenericRelation("LeaveRecord"                           ,TRUST_CHAIN_READ,"type");
		addGenericRelation("LeaveRecord"                           ,TRUST_CHAIN_READ,"platform");
		addGenericRelation("HolydaySetting"                        ,TRUST_CHAIN_READ,"type");
