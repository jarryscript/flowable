...
public class CityJDBCTemplateDAO extends FlowableBaseDAOImpl implements CityDAO{
	...
	*/
	...
	protected boolean isUpdateRequest(City city){
 	...
 	protected Object[] prepareCityUpdateParameters(City city){
 		...
 		parameters[3] = city.nextVersion();
 		parameters[4] = city.getId();
 		parameters[5] = city.getVersion();
