...
import com.doublechain.flowable.LoginForm;
import com.doublechain.flowable.BaseEntity;
import com.doublechain.flowable.CommonError;
import com.doublechain.flowable.DAOGroup;
import com.doublechain.flowable.ManagerGroup;

import com.doublechain.flowable.UserContextImpl;
import com.doublechain.flowable.userapp.UserApp;
import com.doublechain.flowable.FlowableUserContext;
import com.doublechain.flowable.userapp.*;
import com.doublechain.flowable.listaccess.*;
import com.doublechain.flowable.objectaccess.*;
import com.doublechain.flowable.FlowableObjectChecker;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
   ...
   public void setBlockChainAdvancer(BlockChainAdvancer pBlockChainAdvancer){
    ...
    public String confirmSession(FlowableUserContext userContext){
    ...
    public Object resetPassword(FlowableUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(FlowableUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(FlowableUserContext userContext,
    ...
    public SecUser manage(FlowableUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(FlowableUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }

    public SecUser getCachedSecUser(FlowableUserContext userContext) {
    ...
    protected Object gotoApp(FlowableUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(FlowableUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(FlowableUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(FlowableUserContext userContex, int length){
    ...
    protected String getBeanName(FlowableUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(FlowableUserContext userContext, UserApp app){

        return  app.getObjectId();

    }
    protected String getServiceType(FlowableUserContext userContext, UserApp app){

        return app.getObjectType();
    }
    protected String getMethodName(FlowableUserContext userContext, UserApp app){
    ...
    public Object home(FlowableUserContext userContext) {
    ...
    public Object loginWithEmail(FlowableUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"email",email, password);

    }
    public Object login(FlowableUserContext userContext, String email,
            Password password) {
    ...
    public Object loginWithLogin(FlowableUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"login",email, password);

    }
    public Object loginWithMobile(FlowableUserContext userContext, String email,
            Password password) {
        return loginInternal(userContext,"mobile",email, password);

    }
    protected SecUser loadUserWith(FlowableUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(FlowableUserContext userContext, String type, String userId,
            Password password) {
     ...
     */
    protected Object loginTheSecUserInternal(FlowableUserContext userContext, SecUser user, String loginComments) throws Exception {
		...
		iamService.onLoginSecUserInternalSuccess((FlowableUserContextImpl) userContext, user);
    ...
    public Object showlogin(FlowableUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(FlowableUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        FlowableUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected FlowableObjectChecker checker;
    public FlowableObjectChecker getChecker(){
        return checker;
    }

    public void setChecker(FlowableObjectChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((FlowableObjectChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected FlowableUserContextImpl createNewConext(String path) {

        return new CustomFlowableUserContextImpl();
    ...
    public Object checkOtherLogin(FlowableUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(FlowableUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(FlowableUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(FlowableUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(FlowableUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(FlowableUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(FlowableUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
    ...
    public Map<String, Object> testoss(FlowableUserContext userContext) throws SecUserManagerException {
