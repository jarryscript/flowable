<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.formmessage.FormMessage'%>
...
<sky:include page="com/doublechain/flowable/formmessage/FormMessage$Summary.jsp" />
