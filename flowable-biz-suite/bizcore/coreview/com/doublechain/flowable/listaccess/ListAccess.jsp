<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.listaccess.ListAccess'%>
...
<sky:include page="com/doublechain/flowable/listaccess/ListAccess$Summary.jsp" />
