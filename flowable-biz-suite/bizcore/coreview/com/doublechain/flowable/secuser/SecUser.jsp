<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.secuser.SecUser'%>
...
<sky:include page="com/doublechain/flowable/secuser/SecUser$Summary.jsp" />
...
<sky:include page="com/doublechain/flowable/userdomain/UserDomain$Info.jsp" />
		...
		<div id="userAppList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechain/flowable/userapp/UserApp$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["loginHistoryList"] or ignoreListAccessControl}'>
		...
		<div id="loginHistoryList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechain/flowable/loginhistory/LoginHistory$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["wechatWorkappIdentifyList"] or ignoreListAccessControl}'>
		...
		<div id="wechatWorkappIdentifyList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechain/flowable/wechatworkappidentify/WechatWorkappIdentify$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["wechatMiniappIdentifyList"] or ignoreListAccessControl}'>
		...
		<div id="wechatMiniappIdentifyList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechain/flowable/wechatminiappidentify/WechatMiniappIdentify$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
