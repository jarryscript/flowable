<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.genericform.GenericForm'%>
...
<sky:include page="com/doublechain/flowable/genericform/GenericForm$Summary.jsp" />
		...
		<div id="formMessageList" class="tab-pane fade sublist" refer-name="form">
			<sky:include page="com/doublechain/flowable/formmessage/FormMessage$List.jsp"
					referName="form"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["formFieldMessageList"] or ignoreListAccessControl}'>
		...
		<div id="formFieldMessageList" class="tab-pane fade sublist" refer-name="form">
			<sky:include page="com/doublechain/flowable/formfieldmessage/FormFieldMessage$List.jsp"
					referName="form"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["formFieldList"] or ignoreListAccessControl}'>
		...
		<div id="formFieldList" class="tab-pane fade sublist" refer-name="form">
			<sky:include page="com/doublechain/flowable/formfield/FormField$List.jsp"
					referName="form"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["formActionList"] or ignoreListAccessControl}'>
		...
		<div id="formActionList" class="tab-pane fade sublist" refer-name="form">
			<sky:include page="com/doublechain/flowable/formaction/FormAction$List.jsp"
					referName="form"/>
		</div>
	</c:if>
