<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.candidatecontainer.CandidateContainer'%>
...
<sky:include page="com/doublechain/flowable/candidatecontainer/CandidateContainer$Summary.jsp" />
		...
		<div id="candidateElementList" class="tab-pane fade sublist" refer-name="container">
			<sky:include page="com/doublechain/flowable/candidateelement/CandidateElement$List.jsp"
					referName="container"/>
		</div>
	</c:if>
