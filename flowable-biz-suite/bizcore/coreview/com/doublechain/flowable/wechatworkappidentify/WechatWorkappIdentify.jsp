<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.wechatworkappidentify.WechatWorkappIdentify'%>
...
<sky:include page="com/doublechain/flowable/wechatworkappidentify/WechatWorkappIdentify$Summary.jsp" />
