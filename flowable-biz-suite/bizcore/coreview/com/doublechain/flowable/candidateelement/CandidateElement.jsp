<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.candidateelement.CandidateElement'%>
...
<sky:include page="com/doublechain/flowable/candidateelement/CandidateElement$Summary.jsp" />
...
<sky:include page="com/doublechain/flowable/candidatecontainer/CandidateContainer$Info.jsp" />
