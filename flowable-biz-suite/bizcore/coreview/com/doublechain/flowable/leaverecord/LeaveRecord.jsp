<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.leaverecord.LeaveRecord'%>
...
<c:set var="ownerBeanName" value="leaveRecord" scope="request"/>
<c:set var="ownerClassName" value="LeaveRecord" scope="request"/>
...
<div class="row">
	...
	<% LeaveRecord result = (LeaveRecord)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="leaveRecord" value="${ result}" scope="request" />
<sky:include page="com/doublechain/flowable/leaverecord/LeaveRecord$Summary.jsp" />
...
<sky:include page="com/doublechain/flowable/user/User$Info.jsp" />

<c:set var="leaveRecordType" value="${ result.type}" scope="request" />
<c:set var="referName" value="(type)" scope="request" />
<sky:include page="com/doublechain/flowable/leaverecordtype/LeaveRecordType$Info.jsp" />
