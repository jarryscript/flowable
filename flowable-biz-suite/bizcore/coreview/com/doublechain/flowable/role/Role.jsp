<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.role.Role'%>
...
<c:set var="ownerBeanName" value="role" scope="request"/>
<c:set var="ownerClassName" value="Role" scope="request"/>
...
<div class="row">
	...
	<% Role result = (Role)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="role" value="${ result}" scope="request" />
<sky:include page="com/doublechain/flowable/role/Role$Summary.jsp" />
		...
		<div id="userList" class="tab-pane fade sublist" refer-name="role">
