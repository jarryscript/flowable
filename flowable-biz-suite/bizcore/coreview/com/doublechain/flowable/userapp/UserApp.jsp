<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.userapp.UserApp'%>
...
<sky:include page="com/doublechain/flowable/userapp/UserApp$Summary.jsp" />
...
<sky:include page="com/doublechain/flowable/secuser/SecUser$Info.jsp" />
		...
		<div id="quickLinkList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechain/flowable/quicklink/QuickLink$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["listAccessList"] or ignoreListAccessControl}'>
		...
		<div id="listAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechain/flowable/listaccess/ListAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["objectAccessList"] or ignoreListAccessControl}'>
		...
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechain/flowable/objectaccess/ObjectAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
