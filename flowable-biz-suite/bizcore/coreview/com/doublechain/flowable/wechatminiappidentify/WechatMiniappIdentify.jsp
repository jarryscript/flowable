<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.wechatminiappidentify.WechatMiniappIdentify'%>
...
<sky:include page="com/doublechain/flowable/wechatminiappidentify/WechatMiniappIdentify$Summary.jsp" />
