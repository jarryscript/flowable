<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.district.District'%>
...
<c:set var="ownerBeanName" value="district" scope="request"/>
<c:set var="ownerClassName" value="District" scope="request"/>
...
<div class="row">
	...
	<% District result = (District)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="district" value="${ result}" scope="request" />
<sky:include page="com/doublechain/flowable/district/District$Summary.jsp" />
	...
	<div class="row">
<c:set var="city" value="${ result.city}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechain/flowable/city/City$Info.jsp" />

<c:set var="platform" value="${ result.platform}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechain/flowable/platform/Platform$Info.jsp" />
		...
		<div id="userList" class="tab-pane fade sublist" refer-name="district">
			<sky:include page="com/doublechain/flowable/user/User$List.jsp"
					referName="district"/>
		</div>
	</c:if>
