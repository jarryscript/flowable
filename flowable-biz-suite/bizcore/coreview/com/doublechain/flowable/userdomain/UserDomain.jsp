<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.userdomain.UserDomain'%>
...
<sky:include page="com/doublechain/flowable/userdomain/UserDomain$Summary.jsp" />
		...
		<div id="userWhiteListList" class="tab-pane fade sublist" refer-name="domain">
			<sky:include page="com/doublechain/flowable/userwhitelist/UserWhiteList$List.jsp"
					referName="domain"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["secUserList"] or ignoreListAccessControl}'>
		...
		<div id="secUserList" class="tab-pane fade sublist" refer-name="domain">
			<sky:include page="com/doublechain/flowable/secuser/SecUser$List.jsp"
					referName="domain"/>
		</div>
	</c:if>
