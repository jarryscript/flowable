<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.quicklink.QuickLink'%>
...
<sky:include page="com/doublechain/flowable/quicklink/QuickLink$Summary.jsp" />
