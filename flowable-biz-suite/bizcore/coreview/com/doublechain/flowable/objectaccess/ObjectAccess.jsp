<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.objectaccess.ObjectAccess'%>
...
<sky:include page="com/doublechain/flowable/objectaccess/ObjectAccess$Summary.jsp" />
...
<sky:include page="com/doublechain/flowable/userapp/UserApp$Info.jsp" />
