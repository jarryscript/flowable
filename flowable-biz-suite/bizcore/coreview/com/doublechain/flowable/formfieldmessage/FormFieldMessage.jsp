<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.formfieldmessage.FormFieldMessage'%>
...
<sky:include page="com/doublechain/flowable/formfieldmessage/FormFieldMessage$Summary.jsp" />
...
<sky:include page="com/doublechain/flowable/genericform/GenericForm$Info.jsp" />
