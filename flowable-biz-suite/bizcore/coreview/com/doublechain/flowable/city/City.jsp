<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.city.City'%>
...
<c:set var="ownerBeanName" value="city" scope="request"/>
<c:set var="ownerClassName" value="City" scope="request"/>
...
<div class="row">
	...
	<% City result = (City)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="city" value="${ result}" scope="request" />
<sky:include page="com/doublechain/flowable/city/City$Summary.jsp" />
	...
	<div class="row">
<c:set var="province" value="${ result.province}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechain/flowable/province/Province$Info.jsp" />
...
<sky:include page="com/doublechain/flowable/platform/Platform$Info.jsp" />
		...
		<div id="districtList" class="tab-pane fade sublist" refer-name="city">
