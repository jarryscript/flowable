...
<li><span>${userContext.localeMap['user.mobile']}</span> ${user.maskedMobile}</li>
<li><span>${userContext.localeMap['user.avatar']}</span> ${user.avatar}</li>
<li><span>${userContext.localeMap['user.age']}</span> ${user.age}</li>
<li><span>${userContext.localeMap['user.description']}</span> ${user.description}</li>
