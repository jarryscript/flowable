<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.user.User'%>
...
<sky:include page="com/doublechain/flowable/user/User$Summary.jsp" />
	...
	<div class="row">
<c:set var="district" value="${ result.district}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechain/flowable/district/District$Info.jsp" />

<c:set var="role" value="${ result.role}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechain/flowable/role/Role$Info.jsp" />
		...
		<div id="leaveRecordList" class="tab-pane fade sublist" refer-name="user">
