<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.province.Province'%>
...
<c:set var="ownerBeanName" value="province" scope="request"/>
<c:set var="ownerClassName" value="Province" scope="request"/>
...
<div class="row">
	...
	<% Province result = (Province)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="province" value="${ result}" scope="request" />
<sky:include page="com/doublechain/flowable/province/Province$Summary.jsp" />
...
<sky:include page="com/doublechain/flowable/platform/Platform$Info.jsp" />
		...
		<div id="cityList" class="tab-pane fade sublist" refer-name="province">
