<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.platform.Platform'%>
...
<sky:include page="com/doublechain/flowable/platform/Platform$Summary.jsp" />
		...
		<div id="leaveRecordList" class="tab-pane fade sublist" refer-name="platform">
	...
	<c:if test='${not empty userContext.accessTokens["provinceList"] or ignoreListAccessControl}'>
		...
		<div id="provinceList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechain/flowable/province/Province$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["cityList"] or ignoreListAccessControl}'>
		...
		<div id="cityList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechain/flowable/city/City$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["districtList"] or ignoreListAccessControl}'>
		...
		<div id="districtList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechain/flowable/district/District$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
