<%@ page import='java.util.*,com.doublechain.flowable.*,com.doublechain.flowable.holydaysetting.HolydaySetting'%>
...
<c:set var="ownerBeanName" value="holydaySetting" scope="request"/>
<c:set var="ownerClassName" value="HolydaySetting" scope="request"/>
...
<div class="row">
	...
	<% HolydaySetting result = (HolydaySetting)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="holydaySetting" value="${ result}" scope="request" />
<sky:include page="com/doublechain/flowable/holydaysetting/HolydaySetting$Summary.jsp" />
